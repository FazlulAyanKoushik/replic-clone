...
class PublicProductTest(TestCase):
    ...
    def test_Product_list_get_successfully(self):
        ...
        product1 = create_product(name='Test product', category=self.category, price="10.00")
        product2 = create_product(name='Test product', category=self.category, price="10.00")
        product3 = create_product(name='Test product', category=self.category, price="10.00")
        product4 = create_product(name='Test product', category=self.category, price="10.00")
        product5 = create_product(name='Test product', category=self.category, price="10.00")
        product6 = create_product(name='Test product', category=self.category, price="10.00")
        product7 = create_product(name='Test product', category=self.category, price="10.00")
    ...
    def test_top_products_get_successfully(self):
        ...
        product1 = create_product(name='Test product', category=self.category, price="10.00", rating="4.50")
        product2 = create_product(name='Test product', category=self.category, price="10.00", rating="4.50")
        product3 = create_product(name='Test product', category=self.category, price="10.00", rating="4.50")
        product4 = create_product(name='Test product', category=self.category, price="10.00", rating="4.00")
        product5 = create_product(name='Test product', category=self.category, price="10.00", rating="3.50")
        product6 = create_product(name='Test product', category=self.category, price="10.00", rating="2.50")
        product7 = create_product(name='Test product', category=self.category, price="10.00", rating="3.50")
    ...
    def test_product_detail_successfully(self):
        ...
        product = create_product(name='Papaya', category=self.category, price="10.00", rating="4.50")
...
class PrivateProductTest(TestCase):
    ...
    def test_product_create_successfully(self):
        """Testing create product successfully by admin user"""
        payload = {
            'name': 'Test product',
